...
export default function Home() {
  ...
  return (
    <main className="min-h-screen w-full overflow-x-hidden bg-[var(--background)] text-[var(--text)] selection:bg-[var(--primary)]/30">
      {/* BACKGROUND */}

      <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
        <div className="absolute left-1/2 top-[-25rem] h-[50rem] w-[50rem] -translate-x-1/2 rounded-full bg-[var(--primary)]/[0.07] blur-[150px]" />

        <div className="absolute left-[-15rem] top-[35%] h-[28rem] w-[28rem] rounded-full bg-cyan-500/[0.025] blur-[130px]" />

        <div className="absolute right-[-15rem] top-[65%] h-[28rem] w-[28rem] rounded-full bg-violet-500/[0.025] blur-[130px]" />
      ...
      <header className="fixed inset-x-0 top-0 z-50 border-b border-white/[0.055] bg-[var(--background)]/75 backdrop-blur-2xl">
        <div className="mx-auto flex h-[68px] w-full max-w-7xl items-center justify-between px-4 sm:px-8">
          <Link
            href="/"
            className="group flex min-w-0 cursor-pointer items-center gap-3"
          >
            <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border border-[var(--primary)]/30 bg-[var(--primary)]/10 text-lg transition-all duration-300 group-hover:scale-105 group-hover:border-[var(--primary)]/60">
              🩺
            </div>
            ...
            <div className="min-w-0">
              ...
              <div className="hidden text-[8px] font-bold uppercase tracking-[0.22em] text-gray-600 sm:block">
          ...
          <nav className="hidden items-center gap-6 md:flex">
            <Link
              href="/"
              className="cursor-pointer text-xs font-bold text-white transition-colors hover:text-[var(--primary)]"
            >
              Home
            </Link>
            ...
            <Link
              href="/about"
              className="cursor-pointer text-xs font-bold text-gray-500 transition-colors hover:text-white"
            >
              About
            </Link>
            ...
            <Link
              href="/labs"
              className="cursor-pointer rounded-xl border border-[var(--primary)]/30 bg-[var(--primary)]/10 px-4 py-2.5 text-xs font-black text-[var(--primary)] transition-all duration-300 hover:-translate-y-0.5 hover:border-[var(--primary)]/60 hover:bg-[var(--primary)]/15 active:scale-95"
            >
              Launch Simulation
            </Link>
        ...
        {mobileMenuOpen && (
          <div className="max-h-[calc(100dvh-68px)] overflow-y-auto overscroll-contain border-t border-white/[0.06] bg-[var(--card)]/95 px-4 py-4 backdrop-blur-2xl md:hidden">
            <div className="mx-auto flex w-full max-w-7xl flex-col gap-1.5">
              {[
                ...
                <Link
                  ...
                  className="cursor-pointer rounded-xl px-4 py-3.5 text-sm font-bold text-gray-400 transition-all hover:bg-white/[0.04] hover:text-white"
                >
                  {label}
                </Link>
              ))}
              ...
              <Link
                href="/labs"
                onClick={() => setMobileMenuOpen(false)}
                className="mt-2 cursor-pointer rounded-xl border border-[var(--primary)]/30 bg-[var(--primary)]/10 px-4 py-3.5 text-center text-sm font-black text-[var(--primary)] transition-all hover:bg-[var(--primary)]/15 active:scale-[0.98]"
              >
                Launch Simulation
              </Link>
      ...
      <section className="relative w-full px-4 pb-24 pt-32 sm:px-8 sm:pb-32 sm:pt-40">
        <div className="mx-auto w-full max-w-7xl">
          <div className="grid min-w-0 items-center gap-14 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:gap-16 xl:gap-20">
            {/* TEXT */}

            <div
              className={`min-w-0 transition-all duration-[1200ms] ease-[cubic-bezier(0.16,1,0.3,1)] ${
                mounted
                  ? "translate-y-0 opacity-100"
                  : "translate-y-8 opacity-0"
              }`}
            >
              <div className="mb-6 inline-flex max-w-full items-center gap-2 rounded-full border border-[var(--primary)]/20 bg-[var(--primary)]/[0.045] px-3 py-1.5">
                ...
                <span className="truncate text-[8px] font-black uppercase tracking-[0.16em] text-[var(--primary)] sm:text-[9px] sm:tracking-[0.2em]">
                  Clinical Simulation Platform
                </span>
              </div>

              <h1 className="max-w-4xl text-[3.2rem] font-black leading-[0.91] tracking-[-0.055em] text-white sm:text-6xl lg:text-[5rem] xl:text-[5.4rem]">
                Think.
              ...
              <div className="mt-8 flex w-full flex-col gap-3 sm:flex-row">
                <Link
                  href="/labs"
                  className="group inline-flex cursor-pointer items-center justify-center gap-2 rounded-xl bg-[var(--primary)] px-6 py-3.5 text-sm font-black text-white shadow-[0_12px_40px_var(--primary)]/20 transition-all duration-300 hover:-translate-y-1 active:scale-[0.98]"
                >
                ...
                <Link
                  href="/about"
                  className="inline-flex cursor-pointer items-center justify-center rounded-xl border border-white/[0.09] bg-white/[0.025] px-6 py-3.5 text-sm font-bold text-gray-300 transition-all duration-300 hover:-translate-y-1 hover:border-white/20 hover:bg-white/[0.05] active:scale-[0.98]"
                >
              ...
              <div className="mt-10 grid grid-cols-2 overflow-hidden rounded-2xl border border-white/[0.06] sm:grid-cols-4">
                {metrics.map(([value, label], index) => (
                  <div
                    key={label}
                    className={`min-w-0 bg-[var(--card)]/45 p-4 transition-colors duration-300 hover:bg-[var(--card)] ${
                      index < 3
                  ...
                  >
                    ...
                    <div className="mt-1 truncate text-[8px] font-black uppercase tracking-wider text-gray-600">
                      {label}
                    </div>
                  </div>
                ))}
            ...
            <div className="relative min-w-0">
              ...
              <div className="relative mx-auto w-full min-w-0 max-w-[540px]">
                ...
                <div className="relative w-full overflow-hidden rounded-[2rem] border border-white/[0.09] bg-[var(--card)]/80 shadow-[0_30px_100px_rgba(0,0,0,.35)] backdrop-blur-2xl">
                  <div className="flex min-w-0 items-center justify-between gap-3 border-b border-white/[0.06] px-4 py-4 sm:px-5">
                    <div className="flex min-w-0 items-center gap-3">
                      <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border border-[var(--primary)]/20 bg-[var(--primary)]/10">
                        🫀
                      </div>
                      ...
                      <div className="min-w-0">
                        ...
                        <div className="mt-0.5 truncate text-[8px] uppercase tracking-wider text-gray-600">
                          AI patient simulation
                        </div>
                      </div>
                    </div>

                    <div className="flex shrink-0 items-center gap-1.5 rounded-full border border-emerald-400/15 bg-emerald-400/[0.04] px-2.5 py-1">
                  ...
                  <div className="p-4 sm:p-5">
                    ...
                    <div className="mt-4 grid grid-cols-2 gap-2">
                      {[
                        ...
                        <div
                          key={label}
                          className="group flex min-w-0 items-center gap-2.5 rounded-xl border border-white/[0.05] bg-white/[0.018] px-3 py-3 transition-all duration-300 hover:border-[var(--primary)]/20 hover:bg-[var(--primary)]/[0.04]"
                        >
                          <span className="shrink-0 text-sm transition-transform duration-300 group-hover:scale-110">
                            {icon}
                          </span>

                          <span className="truncate text-[9px] font-bold text-gray-500 group-hover:text-gray-300">
                            {label}
                          </span>
                        </div>
                      ))}
                    ...
                    <div className="mt-4 grid grid-cols-3 gap-2">
                      {[
                        ...
                        >
                          ...
                          <div className="truncate text-[7px] text-gray-700">
                            {unit}
                          </div>
                        </div>
                      ))}
                    ...
                    <div className="mt-4 rounded-xl border border-white/[0.05] bg-black/[0.1] p-3">
                      <div className="flex h-8 items-center justify-center gap-[3px] overflow-hidden">
                        {Array.from({ length: 42 }).map((_, index) => (
                          <span
                            key={index}
                            className="w-[2px] shrink-0 rounded-full bg-[var(--primary)]/50"
                            style={{
      ...
      <section className="relative border-y border-white/[0.055] bg-white/[0.012] px-4 py-24 sm:px-8">
        <Reveal className="mx-auto w-full max-w-7xl">
          <div className="grid gap-12 lg:grid-cols-[minmax(0,0.7fr)_minmax(0,1.3fr)] lg:items-end">
            <div>
      ...
      <section className="px-4 py-24 sm:px-8 sm:py-32">
        <div className="mx-auto w-full max-w-7xl">
          ...
          <div className="mt-14 grid min-w-0 gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {features.map((feature, index) => (
              <Reveal
                ...
                className="min-w-0"
              >
                <div className="group relative h-full min-w-0 overflow-hidden rounded-2xl border border-white/[0.06] bg-[var(--card)]/45 p-6 transition-all duration-500 hover:-translate-y-1.5 hover:border-[var(--primary)]/25 hover:bg-[var(--card)]/75">
                  ...
                  <div className="relative">
                    <div className="flex items-center justify-between">
                      <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl border border-white/[0.06] bg-white/[0.025] text-lg transition-all duration-300 group-hover:scale-110 group-hover:border-[var(--primary)]/20 group-hover:bg-[var(--primary)]/10">
                        {feature.icon}
                      </div>
      ...
      <section className="border-y border-white/[0.055] bg-white/[0.012] px-4 py-24 sm:px-8 sm:py-32">
        <div className="mx-auto w-full max-w-7xl">
          <Reveal>
          ...
          <div className="relative mt-16 grid gap-3 sm:grid-cols-2 lg:grid-cols-6">
            ...
            {workflow.map(([number, title, description], index) => (
              ...
              >
                <div className="group h-full min-w-0 rounded-2xl border border-white/[0.06] bg-[var(--card)]/55 p-5 transition-all duration-500 hover:-translate-y-2 hover:border-[var(--primary)]/25 hover:bg-[var(--card)]">
                  <div className="flex h-7 w-7 items-center justify-center rounded-full border border-[var(--primary)]/25 bg-[var(--card)] text-[8px] font-black text-[var(--primary)] transition-all duration-300 group-hover:border-[var(--primary)]/60">
                    {number}
                  </div>
      ...
      <section className="px-4 py-24 sm:px-8 sm:py-32">
        <Reveal className="mx-auto w-full max-w-7xl">
          <div className="relative overflow-hidden rounded-[2rem] border border-[var(--primary)]/15 bg-[var(--card)]/55 p-6 sm:p-10 lg:p-14">
            <div className="absolute -right-32 -top-32 h-80 w-80 rounded-full bg-[var(--primary)]/[0.08] blur-[110px]" />

            <div className="relative grid gap-12 lg:grid-cols-[minmax(0,1fr)_minmax(0,0.8fr)] lg:items-center">
              <div className="min-w-0">
                ...
                <Link
                  href="/dashboard"
                  className="group mt-7 inline-flex cursor-pointer items-center gap-2 rounded-xl border border-white/[0.08] bg-white/[0.025] px-5 py-3 text-xs font-black text-gray-300 transition-all duration-300 hover:-translate-y-1 hover:border-[var(--primary)]/25 active:scale-95"
                >
              ...
              <div className="grid min-w-0 grid-cols-2 gap-2.5">
                {[
                  ...
                  <Reveal key={title} delay={index * 60}>
                    <div className="group min-w-0 rounded-2xl border border-white/[0.06] bg-black/[0.1] p-4 transition-all duration-300 hover:border-[var(--primary)]/20 hover:bg-[var(--primary)]/[0.025]">
                      <div className="text-lg transition-transform duration-300 group-hover:scale-110">
                        {icon}
                      </div>

                      <div className="mt-3 truncate text-[10px] font-black text-gray-300">
                        {title}
                      </div>
      ...
      <section className="border-y border-white/[0.055] bg-white/[0.012] px-4 py-24 sm:px-8">
        <Reveal className="mx-auto w-full max-w-5xl text-center">
      ...
      <section className="relative overflow-hidden px-4 py-28 sm:px-8 sm:py-36">
        ...
        <Reveal className="relative mx-auto w-full max-w-4xl text-center">
          ...
          <Link
            href="/labs"
            className="group mt-8 inline-flex cursor-pointer items-center gap-2 rounded-xl bg-[var(--primary)] px-7 py-4 text-sm font-black text-white shadow-[0_15px_50px_var(--primary)]/20 transition-all duration-300 hover:-translate-y-1 active:scale-[0.98]"
          >
      ...
      <footer className="border-t border-white/[0.055] px-4 py-9 sm:px-8">
